  ...
  return (
    <>
        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="flex flex-wrap items-center gap-6 mt-8 text-gray-300">
            <span className="flex items-center">
              <Building2 size={18} className="mr-2 text-primary-400" />
              {project.client}
            </span>
            <span className="flex items-center">
      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 -mt-8">
        <div className="relative h-64 md:h-[500px] rounded-xl overflow-hidden shadow-xl">
          <Image
            src={project.image}
            alt={project.title}
            fill
      ...
      <section className="py-12 bg-gray-50 mt-12">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          <h2 className="text-2xl font-bold text-gray-900 mb-8 text-center">Proje Sonuçları</h2>
      ...
      <article className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div
          ...
          dangerouslySetInnerHTML={{ __html: formatContent(project.fullDescription) }}
        />

        {/* Services */}
        <div className="mt-12 pt-8 border-t">
          <h3 className="text-xl font-bold text-gray-900 mb-4">Verilen Hizmetler</h3>
      ...
      {project.gallery && project.gallery.length > 1 && (
        <section className="py-12 bg-gray-50">
          <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
            <h2 className="text-2xl font-bold text-gray-900 mb-8 text-center">Proje Görselleri</h2>
      ...
      <section className="py-16 bg-primary-600">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-primary-100 mb-6">
            E-ticaret ve dijital pazarlama hedeflerinizi gerçekleştirmek için bizimle iletişime geçin.
          </p>
          <Link
            href="/teklif"
